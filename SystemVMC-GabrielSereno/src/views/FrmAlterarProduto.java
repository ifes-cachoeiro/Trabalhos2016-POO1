...
public class FrmAlterarProduto extends javax.swing.JFrame {
    ...
    public FrmAlterarProduto(Produto p) {
        initComponents();
        x = p;
        tfEstoque.setText(Integer.toString(p.getEstoque_produto()));
        tfMarca.setText(p.getMarca_produto());
        tfComissao.setText(p.getPccomissao_produto());
        tfMinimoEstoque.setText(Integer.toString(p.getMinestoque_produto()));
        tfModelo.setText(p.getModelo_produto());
        tfNomeProduto.setText(p.getNome_produto());
        tfPrecoCompra.setText(Double.toString(p.getPrecocompra_produto()));
        tfPrecoVenda.setText(Double.toString(p.getPrecovenda_produto()));
        tfUnidade.setText(p.getUnidade_produto());
        ProdutoCRUD.excluir(p);
    }
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(layout.createSequentialGroup()
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addGroup(layout.createSequentialGroup()
                                    .addComponent(tfFornecedor, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(tfPrecoVenda, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 249, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(jLabel6)
                                .addComponent(tfUnidade, javax.swing.GroupLayout.PREFERRED_SIZE, 249, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(jLabel9)
                                .addComponent(tfComissao, javax.swing.GroupLayout.PREFERRED_SIZE, 249, javax.swing.GroupLayout.PREFERRED_SIZE)
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        .addGroup(layout.createSequentialGroup()
                                            ...
                                            .addComponent(tfPrecoCompra, javax.swing.GroupLayout.PREFERRED_SIZE, 277, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addComponent(tfMarca))
                                    .addGap(83, 83, 83)))
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(jLabel8)
                                .addComponent(tfModelo, javax.swing.GroupLayout.PREFERRED_SIZE, 249, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addComponent(tfNomeProduto, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 277, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(jLabel4)
                    .addComponent(tfEstoque, javax.swing.GroupLayout.PREFERRED_SIZE, 277, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btAdicionarFornecedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAdicionarFornecedorActionPerformed
        ...
        obj.setVisible(true);
        if(obj.isConfirmado()){
            x.setFornecedor_produto(obj.getFornecedor());

            tfFornecedor.setText(x.getFornecedor_produto().getNome_fornecedor());
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                FrmAlterarProduto obj = new FrmAlterarProduto(produto);
                obj.setVisible(true);
            }
        });
    }
