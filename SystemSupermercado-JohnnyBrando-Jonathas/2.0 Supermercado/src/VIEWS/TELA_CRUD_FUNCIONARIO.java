 ...
 * @author Nunu
 */
public class TELA_CRUD_FUNCIONARIO extends javax.swing.JFrame {

    /**
     * Creates new form TELA_CRUD
     */
    public TELA_CRUD_FUNCIONARIO() {
        initComponents();
    }
    ...
    private void CadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CadActionPerformed
        // TODO add your handling code here:
        JFrameCadFuncionario cad = new JFrameCadFuncionario();
        cad.setVisible(true);
        this.dispose();
    ...
    private void ExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ExcluirActionPerformed
        // TODO add your handling code here:
        JFrameExcluirFuncionario ex_funci = new JFrameExcluirFuncionario();
        ex_funci.setVisible(true);
        this.dispose();
    ...
    private void AlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AlterarActionPerformed
        // TODO add your handling code here:
        this.dispose();
        FuncionarioCRUD.alterarFuncionario();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TELA_CRUD_FUNCIONARIO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TELA_CRUD_FUNCIONARIO().setVisible(true);
            }
        });
    }
