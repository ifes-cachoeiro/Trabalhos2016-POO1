 ...
 * @author luisa
 */
public class FrmAdicionarFornecedor extends javax.swing.JFrame {
    ...
    private void brSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_brSalvarActionPerformed
        ...
        if (tfNome.getText().equals("") || jcCidade.getSelectedItem().equals("Escolha") || tfBairro.getText().equals("")
                || tfRua.getText().equals("") || tfNumero.getText().equals("") || jfCnpj.getText().equals("")
                || jfTel.getText().equals("")) {
            ...
            f.setCidade(cidade.getCod_cidade());
            f.setBairro(tfBairro.getText());
            f.setRua(tfRua.getText());
            f.setNumero(Integer.parseInt(tfNumero.getText()));
            f.setCpf(jfCnpj.getText());
            f.setTelefone(jfTel.getText());
            if (fornecedorCRUD.create(f) == true) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmAdicionarFornecedor().setVisible(true);
            }
        });
    }
