    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(tfCodCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 171, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        if (tfCodCliente.getText().equals("")) {
            ...
            for (Cliente cliente : DataBase.lstCliente) {
                if (cliente.getCod_cliente() == codAux) {
                    ...
                    JFrmAddCliente ecc = new JFrmAddCliente(1,codAux);
                    ecc.setVisible(true);
                    i = 1;
                    break;
                }
            ...
            if (i == 0) {
                ...
                JFrmErroAlterarCliente s = new JFrmErroAlterarCliente(text, 0, codAux);
                s.setVisible(true);
            }
        }
