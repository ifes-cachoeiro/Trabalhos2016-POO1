 ...
 * @author Vinicius
 */
public class JFrmListarProfessor extends javax.swing.JFrame {

    /**
     * Creates new form JFrmListarProfessor
     */
    public JFrmListarProfessor() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tab.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "Código", "Especialidade", "Cpf", "Bairro", "Cep", "Salário", "Sexo", "Telefone"
            }
        ));
        ...
        jLabel4.setText("Listagem de Professores");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ProfessorCRUD ec = new ProfessorCRUD();
        DefaultTableModel tabela = (DefaultTableModel) tab.getModel();
        tabela.setNumRows(0);
        tfCod.setText("");
        for(Professor p : ec.ler()){
            tabela.addRow(p.obterDados(p));
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrmListarProfessor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrmListarProfessor().setVisible(true);
            }
        });
    }
