 ...
 * @author Vinicius
 */
public class JFrmListarTurma extends javax.swing.JFrame {

    /**
     * Creates new form JFrmListarTurma
     */
    public JFrmListarTurma() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tab.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código turma", "Nome do tipo", "Professor"
            }
        ));
        ...
        jLabel4.setText("Listagem de Turmas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrmListarTurma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrmListarTurma().setVisible(true);
            }
        });
    }
