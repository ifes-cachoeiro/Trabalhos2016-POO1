...
public class JFrmLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/files/birrl.png"))); // NOI18N
    ...
    private void btEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEntrarActionPerformed
        // TODO add your handling code here:
        AdminCRUD admc = new AdminCRUD();
        if (admc.verifica(tfUsuario.getText(), tfSenha.getText()) == true) {
            dispose();
            JFrmMenu m = new JFrmMenu();
            m.setVisible(true);
        }else{
            dispose();
            JFrmSucesso s = new JFrmSucesso("ERRO! Usuário ou Senha incorretos.", 1);
            s.setVisible(true);
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        this.dispose();
        JFrmAddAdmin m = new JFrmAddAdmin();
        m.setVisible(true);
