 ...
 * @author thiag
 */
public class IFrmAlterarUsuario extends javax.swing.JInternalFrame {
    Usuario u;
    /**
     * Creates new form IFrmNovoUsuario
     */
    public IFrmAlterarUsuario(Usuario usuario) {
        initComponents();
        this.u = usuario;
        tfEmailUsuario.setText(u.getEmail());
        tfNomeUsuario.setText(u.getNome());
        pfSenhaUsuario.setText(u.getSenha());
    }
    ...
    private void btAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAlterarActionPerformed
        ...
        crudUsuario.AlterarUsuario(u, tfEmailUsuario.getText(), pfSenhaUsuario.getText(), 
