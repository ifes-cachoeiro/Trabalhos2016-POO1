 ...
 * @author thiag
 */
public class IFrmListarUsuario extends javax.swing.JInternalFrame {

    /**
     * Creates new form IFrmListarFuncao
     */
    public IFrmListarUsuario() {
        initComponents();
    }
    ...
    private void btListarTodosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btListarTodosActionPerformed
        ...
        DefaultTableModel tabela = (DefaultTableModel) tbUsuario.getModel();
        tabela.setNumRows(0);
        for(Usuario u : Dados.lstUsuario){
            tabela.addRow(u.lerDados(u));
        }
    ...
    private void btProcurarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btProcurarActionPerformed
        ...
        tabela.setNumRows(0);
        for(Usuario u : Dados.lstUsuario){
            if(tfNome.getText().equals(u.getNome())){
                tabela.addRow(u.lerDados(u));
            }
        }
