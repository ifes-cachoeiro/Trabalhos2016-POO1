 ...
 * @author thiag
 */
public class IFrmListarEntrega extends javax.swing.JInternalFrame {

    /**
     * Creates new form IFrmListarFuncao
     */
    public IFrmListarEntrega() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tbEntrega = new javax.swing.JTable();
        ...
        setTitle("Listar Entrega");

        tbEntrega.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID", "Data", "Rota", "Placa do Veículo"
            }
        ));
        jScrollPane1.setViewportView(tbEntrega);
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(tfRota, javax.swing.GroupLayout.PREFERRED_SIZE, 173, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
    ...
    private void btListarTodosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btListarTodosActionPerformed
        ...
        DefaultTableModel tabela = (DefaultTableModel) tbEntrega.getModel();
        tabela.setNumRows(0);
        for(Entrega e : Dados.lstEntrega){
            tabela.addRow(e.lerDados(e));
        }
    ...
    private void btProcurarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btProcurarActionPerformed
        ...
        tabela.setNumRows(0);
        for(Entrega e : Dados.lstEntrega){
            if(tfRota.getText().equals(e.getRota())){
                tabela.addRow(e.lerDados(e));
            }
        }
    ...
    private javax.swing.JTable tbEntrega;
